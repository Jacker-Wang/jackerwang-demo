...
/**
 * 类目控制器 Created by shujackerwang on 2016/11/14.
 */
@Controller
...
public class CmsCategoryController extends BaseController {
    ...
    public Object create(CmsCategory cmsCategory) {
        ComplexResult result = FluentValidator.checkAll().on(cmsCategory.getName(), new LengthValidator(1, 20, "名称")).doValidate()

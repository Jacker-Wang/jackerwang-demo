package com.jackerwang.upms.server.interceptor;
...
/**
 * 登录信息拦截器 Created by shujackerwang on 2017/2/11.
 */
public class UpmsInterceptor extends HandlerInterceptorAdapter {
    ...
    private static final String ZHENG_OSS_ALIYUN_OSS_POLICY = PropertiesFileUtil.getInstance("jackerwang-oss-client").get("jackerwang.oss.aliyun.oss.policy");

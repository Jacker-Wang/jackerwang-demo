package com.jackerwang.upms.client.shiro.session;
...
import com.jackerwang.upms.client.util.SerializableUtil;
import com.jackerwang.upms.common.constant.UpmsConstant;

import redis.clients.jedis.Jedis;

/**
 * 基于redis的sessionDao，缓存共享session Created by shujackerwang on 2017/2/23.
 */
public class UpmsSessionDao extends CachingSessionDAO {
    ...
    // 会话key
    private final static String ZHENG_UPMS_SHIRO_SESSION_ID = "jackerwang-upms-shiro-session-id";
    // 全局会话key
    private final static String ZHENG_UPMS_SERVER_SESSION_ID = "jackerwang-upms-server-session-id";
    // 全局会话列表key
    private final static String ZHENG_UPMS_SERVER_SESSION_IDS = "jackerwang-upms-server-session-ids";
    // code key
    private final static String ZHENG_UPMS_SERVER_CODE = "jackerwang-upms-server-code";
    // 局部会话key

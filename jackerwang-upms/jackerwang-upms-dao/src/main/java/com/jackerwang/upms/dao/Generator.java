package com.jackerwang.upms.dao;

import java.util.HashMap;
import java.util.Map;

import com.jackerwang.common.util.MybatisGeneratorUtil;
...
public class Generator {
    ...
    // 根据命名规范，只修改此常量值即可
    private static String MODULE = "jackerwang-upms";
    private static String DATABASE = "zheng";
    private static String TABLE_PREFIX = "upms_";
    private static String PACKAGE_NAME = "com.jackerwang.upms";

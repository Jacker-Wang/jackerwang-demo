...
import com.jackerwang.common.util.StringUtil;
...
/**
 * 设置控制器 Created by shujackerwang on 2017/3/18.
 */
@Controller
...
public class CmsSettingController extends BaseController {
    ...
    public Object create(CmsSetting cmsSetting) {
        ComplexResult result = FluentValidator.checkAll().on(cmsSetting.getSettingKey(), new LengthValidator(1, 20, "键")).doValidate()
